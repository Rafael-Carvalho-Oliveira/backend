...
class AgendamentoModel(db.Model):
    ...
    # Relacionamentos
    usuario = relationship("UsuarioModel", backref="tb_agendamento")
    profissional = relationship("ProfissionalModel", backref="tb_agendamento")
    servico = relationship("ServicoModel", backref="tb_agendamento")
